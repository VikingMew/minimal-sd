...
class Script:
    ...
    def elem_id(self, item_id):
        ...
        tabname = (
            ("img2img" if self.is_img2img else "txt2txt") + "_" if need_tabname else ""
        )
...
class ScriptRunner:
    ...
    def initialize_scripts(self, is_img2img):
        ...
        for script_class, path, basedir, script_module in (
            auto_processing_scripts + scripts_data
        ):
            script = script_class()
    ...
    def process(self, p):
        print("always on", self.alwayson_scripts)
        for script in self.alwayson_scripts:
            try:
    ...
    def process_batch(self, p, **kwargs):
        for script in self.alwayson_scripts:
            try:
                ...
                print(
                    f"Error running process_batch: {script.filename}", file=sys.stderr
                )
                print(traceback.format_exc(), file=sys.stderr)
    ...
    def postprocess_batch(self, p, images, **kwargs):
        for script in self.alwayson_scripts:
            try:
                ...
                print(
                    f"Error running postprocess_batch: {script.filename}",
                    file=sys.stderr,
                )
                print(traceback.format_exc(), file=sys.stderr)
    ...
    def before_component(self, component, **kwargs):
        for script in self.scripts:
            try:
                ...
                print(
                    f"Error running before_component: {script.filename}",
                    file=sys.stderr,
                )
                print(traceback.format_exc(), file=sys.stderr)
    ...
    def after_component(self, component, **kwargs):
        for script in self.scripts:
            try:
                ...
                print(
                    f"Error running after_component: {script.filename}", file=sys.stderr
                )
                print(traceback.format_exc(), file=sys.stderr)
