    ...
    options_section(
        ("saving-images", "Saving images/grids"),
        {
            ...
            "img_downscale_threshold": OptionInfo(
                4.0, "File size limit for the above option, MB", None
            ),
            "target_side_length": OptionInfo(
                4000, "Width/height limit for the above option, in pixels", None
            ),
            "img_max_size_mp": OptionInfo(
                200, "Maximum image size, in megapixels", None
            ),
    ...
    options_section(
        ("sd", "Stable Diffusion"),
        {
            ...
            "CLIP_stop_at_last_layers": OptionInfo(
                1, "Clip skip", None, {"minimum": 1, "maximum": 12, "step": 1}
            ),
    ...
    options_section(
        ("extra_networks", "Extra Networks"),
        {
            ...
            "sd_hypernetwork": OptionInfo(
                ...
                None,
                lambda: {"choices": [""] + [x for x in hypernetworks.keys()]},
    ...
    options_section(
        ("ui", "User interface"),
        {
            ...
            "hidden_tabs": OptionInfo(
                ...
                None,
                lambda: {"choices": [x for x in tab_names]},
            ),
            "ui_reorder": OptionInfo(
                ", ".join(ui_reorder_categories), "txt2img/img2img UI item order"
            ),
    ...
    options_section(
        ("ui", "Live previews"),
        {
            ...
            "show_progress_type": OptionInfo(
                ...
                None,
                {"choices": ["Full", "Approx NN", "Approx cheap"]},
            ),
            ...
            "live_preview_refresh_period": OptionInfo(
                1000, "Progressbar/preview update period, in milliseconds"
            ),
        },
    )
)
    ...
    options_section(
        ("sampler-params", "Sampler parameters"),
        {
            ...
            "eta_noise_seed_delta": OptionInfo(
                0, "Eta noise seed delta", None, {"precision": 0}
            ),
