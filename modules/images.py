...
class FilenameGenerator:
    ...
    def datetime(self, *args):
        ...
        time_format = (
            args[0] if len(args) > 0 and args[0] != "" else self.default_time_format
        )
        try:
...
def save_image(
    ...
    def _atomically_save_image(image_to_save, filename_without_extension, extension):
        ...
        if extension.lower() == ".png":
            ...
            if image_to_save.mode == "RGBA":
                ...
                image_to_save = image_to_save.point(
                    lambda p: p * 0.0038910505836576
                ).convert("RGB" if extension.lower() == ".webp" else "L")
            ...
            image_to_save.save(
                temp_file_path, format=image_format, quality=opts.jpeg_quality
            )
    ...
    print("save image", fullfn, txt_fullfn)
