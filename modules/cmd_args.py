...
parser.add_argument(
    "--update-check",
    action="store_true",
    help="launch.py argument: chck for updates at startup",
)
parser.add_argument(
    "--tests",
    type=str,
    default=None,
    help="launch.py argument: run tests in the specified directory",
)
parser.add_argument(
    "--no-tests",
    action="store_true",
    help="launch.py argument: do not run tests even if --tests option is specified",
)
parser.add_argument(
    "--skip-install",
    action="store_true",
...
parser.add_argument(
    "--opt-sdp-attention",
    action="store_true",
    help="enable scaled dot product cross-attention layer optimization; requires PyTorch 2.*",
)
parser.add_argument(
    "--opt-sdp-no-mem-attention",
    action="store_true",
    help="enable scaled dot product cross-attention layer optimization without memory efficient attention, makes image generation deterministic; requires PyTorch 2.*",
)
parser.add_argument(
