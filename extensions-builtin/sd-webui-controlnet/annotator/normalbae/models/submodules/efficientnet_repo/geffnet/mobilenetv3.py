...
model_urls = {
    "mobilenetv3_rw": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/mobilenetv3_100-35495452.pth",
    "mobilenetv3_large_075": None,
    "mobilenetv3_large_100": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/mobilenetv3_large_100_ra-f55367f5.pth",
    "mobilenetv3_large_minimal_100": None,
    "mobilenetv3_small_075": None,
    "mobilenetv3_small_100": None,
    "mobilenetv3_small_minimal_100": None,
    "tf_mobilenetv3_large_075": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_large_075-150ee8b0.pth",
    "tf_mobilenetv3_large_100": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_large_100-427764d5.pth",
    "tf_mobilenetv3_large_minimal_100": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_large_minimal_100-8596ae28.pth",
    "tf_mobilenetv3_small_075": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_small_075-da427f52.pth",
    "tf_mobilenetv3_small_100": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_small_100-37f49e2b.pth",
    "tf_mobilenetv3_small_minimal_100": "https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-weights/tf_mobilenetv3_small_minimal_100-922a7843.pth",
}
...
class MobileNetV3(nn.Module):
    ...
    def __init__(
        ...
        self.conv_head = select_conv2d(
            in_chs, num_features, 1, padding=pad_type, bias=head_bias
        )
    ...
    with layer_config_kwargs(kwargs):
        model_kwargs = dict(
            ...
            se_kwargs=dict(
                ...
                gate_fn=get_act_fn("hard_sigmoid"),
                reduce_mid=True,
                divisor=8,
            ),
            norm_kwargs=resolve_bn_args(kwargs),
...
def mobilenetv3_large_minimal_100(pretrained=False, **kwargs):
    ...
    # NOTE for train set drop_rate=0.2
    model = _gen_mobilenet_v3(
        "mobilenetv3_large_minimal_100", 1.0, pretrained=pretrained, **kwargs
    )
    return model
...
def mobilenetv3_small_minimal_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v3(
        "mobilenetv3_small_minimal_100", 1.0, pretrained=pretrained, **kwargs
    )
    return model
