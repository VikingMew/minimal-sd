        ...
        with torch.no_grad():
            ...
            while True:
                ...
                if frame is not None:
                    ...
                    cv2.imshow(
                        "MiDaS Depth Estimation - Press Escape to close window ",
                        content / 255,
                    )
                    ...
                    if output_path is not None:
                        filename = os.path.join(
                            output_path,
                            "Camera" + "-" + model_type + "_" + str(frame_index),
                        )
                        cv2.imwrite(filename + ".png", content)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-o", "--output_path", default=None, help="Folder for output images"
    )
    ...
    parser.add_argument(
        ...
        dest="optimize",
        action="store_true",
        help="Use half-float optimization",
    )
